        ...
        <?php
          if(isset($_GET['filter']) && ! empty($_GET['filter'])){
            ...
            if($filter == '1'){
              ...
              UNION SELECT penduduk.nama, penduduk.desa, penduduk.rt, penduduk.rw, surat_lapor_hajatan.no_surat, surat_lapor_hajatan.tanggal_surat, surat_lapor_hajatan.jenis_surat FROM penduduk LEFT JOIN surat_lapor_hajatan ON surat_lapor_hajatan.nik = penduduk.nik WHERE surat_lapor_hajatan.status_surat='selesai'
              ...
              UNION SELECT penduduk.nama, penduduk.desa, penduduk.rw, penduduk.rt, surat_lapor_hajatan.no_surat, surat_lapor_hajatan.tanggal_surat, surat_lapor_hajatan.jenis_surat FROM penduduk LEFT JOIN surat_lapor_hajatan ON surat_lapor_hajatan.nik = penduduk.nik WHERE surat_lapor_hajatan.status_surat='selesai' AND DATE(surat_lapor_hajatan.tanggal_surat)='{$_GET['tanggal']}'
          ...
          <tbody>
            ...
            ?>
                  <tr>
                    ...
                    <td style="text-transform: capitalize;"><?php echo "Desa. ".$data['desa'].", RT".$data['rt']."/RW".$data['rw']; ?></td>
                  </tr>
            <?php
                }
              }else{
