...
?>
			...
			<body>
				<div>
					<table width="100%">
						<tr><img src="../../../../assets/img/logo-banten.png" alt="" class="logo"></tr>
						<div class="header">
					...
					<div id="isi3">
						...
						<table width="100%">
							<tr>
								<td class="indentasi">Benar nama tersebut diatas warga desa kami, menurut keterangan ketua RT/RW setempat dan sepengetahuan kami bahwa yang bersangkutan adalah termasuk : <strong>Keluarga Tidak Mampu</strong><a style="text-transform: capitalize;">, Desa <?php echo $rows['nama_desa']; ?>, Kecamatan <?php echo $rows['kecamatan']; ?> <?php echo $rows['kota']; ?></a>. Bahwa nama yang bersangkutan tidak berada di rumah dan tidak diketahui keberadaannya.</td>
							</tr>
						</table><br>
						<table width="100%">
							<tr>
